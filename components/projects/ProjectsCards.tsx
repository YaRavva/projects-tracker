          ...
          <div className="mt-auto">
            ...
            <div className="flex justify-between items-center pt-2 pb-2">
              <div className="flex items-center space-x-3">
                ...
                {project.deadline && (
                  <span className="text-xs text-gray-300 bg-glass-bg px-2.5 py-1.5 rounded-full border border-glass-border flex items-center shadow-glow-sm">
                    <svg className="w-3 h-3 mr-1.5 text-cryptix-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
